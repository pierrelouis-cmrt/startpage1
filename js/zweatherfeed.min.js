    ...
    return this.each(function (q, t) {
      ...
      var w = function (f, c, e) {
          ...
          if ("Yahoo! Weather Error" != c.description) {
            ...
            e.country &&
              (b +=
                '<div class="weatherCountry">' + c.location.country + "</div>");
            b +=
            ...
            e.humidity &&
              (b +=
                '<div class="weatherHumidity">Humidity: ' +
                c.atmosphere.humidity +
                "</div>");
            e.visibility &&
              (b +=
                '<div class="weatherVisibility">Visibility: ' +
                c.atmosphere.visibility +
                "</div>");
            e.sunrise &&
              (b +=
                '<div class="weatherSunrise">Sunrise: ' +
                c.astronomy.sunrise +
                "</div>");
            e.sunset &&
              (b +=
                '<div class="weatherSunset">Sunset: ' +
                c.astronomy.sunset +
                "</div>");
            if (e.forecast) {
              ...
              for (g = 0; g < a.length; g++)
                (b +=
                  '<div class="weatherForecastItem" style="background-image: url(http://l.yimg.com/a/i/us/nws/weather/gr/' +
                  a[g].code +
                  's.png); background-repeat: no-repeat;">'),
                  (b +=
                    '<div class="weatherForecastDay">' + a[g].day + "</div>"),
                  (b +=
                    '<div class="weatherForecastDate">' + a[g].date + "</div>"),
                  (b +=
                    '<div class="weatherForecastText">' + a[g].text + "</div>"),
                  (b +=
                    '<div class="weatherForecastRange">High: ' +
                    a[g].high +
                    " Low: " +
                    a[g].low +
                    "</div>"),
            ...
            e.link &&
              (b +=
                '<div class="weatherLink"><a href="' +
                c.link +
                '" target="' +
                e.linktarget +
                '" title="Read full forecast">Full forecast</a></div>');
          } else
            (b = '<div class="weatherItem ' + p + '">'),
